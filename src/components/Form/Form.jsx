...
const Form = () => {
    ...
    const { clearCart, carrito, totalCarrito } = useContext(cartContext);
            ...
            {finish === false ? (
                <div className="p-8 flex flex-col">
                    ...
                    <form onSubmit={handleSubmit} className="justify-center pt-6">
                        ...
                        <div className="mt-2 flex-col">
                            <div>
                                <input className="border rounded border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="tel" id="telefono" name="telefono" placeholder="XXXX-XXXX" pattern="[0-9]{4}-[0-9]{4}" required />
                            </div>
                        </div>
                ...
                (
                    <div className="p-8 flex flex-col justify-center items-center">
                        <h3 className="sm:text-2xl font-medium text-red-500">GRACIAS POR TU COMPRA</h3>
                        <p className="text-sm">Ticket final para reclamos</p>
